  ...
  const contributions = [
    {
      title: "TheHealthApp",
      description:
        "A comprehensive healthcare application designed to improve patient care and streamline medical processes. Features include patient management, appointment scheduling, and health analytics.",
      tags: ["React.js", "Node.js", "Healthcare", "PostgreSQL", "API Integration"],
      link: "https://github.com/oss-slu/TheHealthApp",
    },
  ]
